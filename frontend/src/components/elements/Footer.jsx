      ...
      <div className="grid max-w-5xl grid-cols-1 gap-8 px-6 mx-auto sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          <p className="mb-4 text-lg">
            Empowering students and recruiters with AI-driven tools and career
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          <ul>
            <li>
              <a href="/about" className="text-lg hover:text-[#001631] mb-2">
                About Us
              </a>
            </li>
            <li>
              <a href="/signup" className="text-lg hover:text-[#001631] mb-2">
                Sign Up
              </a>
            </li>
            <li>
              <a href="/login" className="text-lg hover:text-[#001631] mb-2">
                Login
              </a>
            </li>
            <li>
              <a href="/contact" className="text-lg hover:text-[#001631] mb-2">
                Contact
              </a>
            </li>
            <li>
              <a
                href="/privacy-policy"
                className="text-lg hover:text-[#001631] mb-2"
              >
                Privacy Policy
              </a>
            </li>
        ...
        <div className="flex flex-col items-center sm:items-start">
          ...
          <ul>
            <li>
              <p className="text-lg hover:text-[#001631] mb-2">How It Works</p>
            </li>
            <li>
              <p className="text-lg hover:text-[#001631] mb-2">Find Jobs</p>
            </li>
          </ul>
        </div>
